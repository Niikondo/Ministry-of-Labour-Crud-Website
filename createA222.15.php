...
do {
    ...
    $sql ="INSERT INTO a22215 (Name_of_Applicant, Date_Received, Positions, Number_of_Positions, No_of_Positions_Recommended, No_of_Positions_not_Recommended,Remarks, Exemption_end_date, filename ) " .
          "VALUES('$Name_of_Applicant','$Date_Received','$Positions' ,'$Number_of_Positions','$No_of_Positions_Recommended','$No_of_Positions_not_Recommended','$Remarks','$Exemption_end_date','$filename')";
...
<div style="margin-left:200px">
            <div class= "row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-secondary" href="officeA222.15.php" role="button">Cancel</a>
            </div>
            </div>
        </div>
        </div>
