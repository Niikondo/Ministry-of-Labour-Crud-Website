...
do {
    ...
    $sql ="INSERT INTO a22223 (Name_of_Applicant, Date_Received, Positions, Number_of_Positions, No_of_Positions_Recommended, No_of_Positions_not_Recommended,Remarks, Exemption_end_date ) " .
...
<header>
            ...
            <div class="container-5 " style="background-color:lightgrey,   text-align: center;
               border:black; width:1500px; border-width:5px;margin-right: 150px; margin-left: 290px; border-style:solid;background:lightgrey;padding:10px;border-radius: 23px; margin-top:-20px">
...
<div style="margin-left:200px">
            <div class= "row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-secondary" href="officeA222.23.php" role="button">Cancel</a>
            </div>
            </div>
        </div>
        </div>
