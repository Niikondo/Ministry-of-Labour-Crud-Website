...
<head>
	...
	<title>downloadA110.15.php</title>
</head>
<body>
...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading">
            Record List
            <a href="csvA110.15.php" class="btn btn-success pull-right">Export Record</a>
        </div>
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <?php
                    ...
                    $query = $db->query("SELECT * FROM a11015 ORDER BY Date_Received DESC");
                    if($query->num_rows > 0){ 
