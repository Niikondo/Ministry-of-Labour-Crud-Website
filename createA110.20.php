...
do {
    ...
    $sql ="INSERT INTO a11020 (Organization, Date_Received, Department_Division, Approval_Period, Requested_Section, Date_Sign_by_the_Minister,Exemp_Contops) " .
...
<div style="margin-left:200px">
            <div class= "row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-secondary" href="officeA110.20.php" role="button">Cancel</a>
            </div>
            </div>
        </div>
        </div>
